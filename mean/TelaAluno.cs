...
public class Aluno : Tela
{
        ...
        Point cursor, bool isDown, string text)
    {
        try
        {
            ...
            Rectangle PreenchimentoTirarFoto = new Rectangle(bmp.Width - (larguraCamera / 3 - 25), alturaCamera + 15, (larguraCamera / 3 - 30), (alturaBotao / 2) - 10);
            ...
            g.DrawRectangle(CanetaPreta, Explicacao);
